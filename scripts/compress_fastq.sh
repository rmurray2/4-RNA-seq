...
echo "Blank lines in sortMeRna files (STAR aligner input should NOT contain blank lines):" >> OUT/blank_lines_check.txt
...
then
    ...
    grep -E --line-number --with-filename '^$' $my_file >> OUT/blank_lines_check.txt
